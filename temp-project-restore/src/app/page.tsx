                ...
                {isFreePlan && (
                  <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-6 mb-8 text-white">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
                      ...
                      <button
                        onClick={async () => {
                          // Redirecionar diretamente para checkout do Plano Profissional
                          if (!user) {
                          ...
                          try {
                            const response = await fetch('/api/stripe/create-checkout-session', {
                              ...
                              body: JSON.stringify({
                                priceId: 'price_silver_placeholder', // Será substituído pela price_id real do Stripe
                                userId: user.id,
                            ...
                            if (response.ok) {
                              ...
                              // Fallback para página de planos
                              setActiveModule("Planos");
                            }
                          } catch (error) {
